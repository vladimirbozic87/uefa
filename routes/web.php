...
Route::get('/formation/{name}/{game_id}', 'GameController@getFormation')->name('get-formation');

Route::post('/formation/{name}/{game_id}', 'GameController@postFormation')->name('post-formation');
